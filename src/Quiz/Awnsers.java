...
public class Awnsers {
    ...
    public static void main(String[] args) {
    	 ...
    	 String[][] Izveles = {
    	            ...
    	            {"for (int i = 0; i < arr.length; i++) { for (int j = 0; j < arr[i].length; j++) { System.out.print(arr[i][j] + ' '); } }", "for (int[] row : arr) { for (int val : row) { System.out.print(val + ' '); } }", "for (int i = 0; i < arr.length; i++) { System.out.println(Arrays.toString(arr[i])); }", "for (int i = 0; i < arr.length; i++) { for (int j = 0; j < arr[i].length; j++) { System.out.println(arr[i][j]); } }"},
